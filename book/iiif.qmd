...
- Implement the IIIF Presentation API which creates the all important IIIF Manifest files (there are many open source or vendor products that help handle this). IIIF Manifests combine information about your images and structural data from your metadata source. The Manifest file is really the prime unit in IIIF. It contains all the information that makes up your new IIIF enabled object, from how to display it, what information to display (such as structure or the order of pages, or even where an illustration is located within in an image, it can be as complex as you need!).  
- Choose one of the many [IIIF enabled viewers](https://iiif.io/get-started/iiif-viewers/) to show your images via your own collection site.
