...
Making your collections IIIF enabled makes it easier to share your content online in a consistent way, enabling portability across different [IIIF enabled viewers](https://iiif.io/get-started/iiif-viewers/). This means that rather than endless copies of your objects being shipped and sent all over the world for different projects, they can stay on your same IIIF Image server, but be accessed and displayed by viewers hosted at institutions elsewhere. 

### Open Community
IIIF is an open, global community, backed by a consortium of leading cultural institutions, working together to develop open APIs, implement them in software, and expose images and A/V files. It’s a grassroots effort between many different institutions to solve their shared problems with delivering, managing, sharing, and working with their resources. The IIIF community is large and growing, and the standard has been formally adopted by [over 100 major cultural heritage organisations worldwide](https://iiif.io/guides/finding_resources/) including a substantial number of LIBER members.
...
There are quite a number of use cases and case studies available on the [IIIF Demos page] (https://iiif.io/demos/) but let's have a look at three real life (and canonical) examples of IIIF in action.
