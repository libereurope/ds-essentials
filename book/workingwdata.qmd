...
>Contributed by: Niamh Malin, [ORCID](https://orcid.org/0000-0002-4735-2113)  
>Original published date: \[DD/MM/YYYY\]  
>Last modified: See Github page history
>
>Suggested Citation: Niamh Malin, “Working with Data,” *Digital Scholarship & Data Science Essentials for Library Professionals* (2024), [DOI link tbd]
...
_A new book has arrived, you create a record on the library management system filling in the title, ISBN and price._:
...
- [**Libraries support data-driven decision making**](https://hangingtogether.org/libraries-support-data-driven-decision-making/) (February 2024). An OCLC-Liber blog post following their “Building for the future” program where librarians had gathered to discuss their understanding and practical interpretations of data driven libraries.
- [**Utilising new modes of data to enhance research strategy and collaboration**](https://www.timeshighereducation.com/campus/utilising-new-modes-data-enhance-research-strategy-and-collaboration?spMailingID=27812157&spUserID=MTQ4NjQ5NDYyNDE5MgS2&spJobID=2351611476&spReportId=MjM1MTYxMTQ3NgS2) (November 2023). Digital science looks at how institutions can get high-quality insights into research by standardising their data systems.
