...
This guide will explore the use of data within libraries through; questions to think through when undertaking your own data tasks, alongside practical examples from libraries around the world.
