...
3. Allocate/Confirm individual Topic Guide Authorship (15 minutes): As a group we'll go over the wishlist and all participants will be given access to the Topic Guide google doc template associated with the guide they'll be authoring during the sprint.
4. Writing Phase (60 minutes): You'll begin writing your respective guide, if more than one are working together we can provide breakout rooms. You can have your camera/mic on or off during this time and co-chairs will be on hand to answer any questions or advice on topics.
5. Wrapping Up: Logging progress through Github Issues (15 minutes): We have provided an issue template which is pre-formatted as a Topic Guide submission checklist. Please go through the issue template and provide the necessary information relating to where your draft submission is currently at. Once the issue is saved, it can continue to serve as a space to continue discussion of the ongoing status of your submission and log updates where necessary, including notifying us of when it is fully ready for final review by maintainers. 
