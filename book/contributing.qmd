...
> These guidelines are written specifically for attendees wishing to contribute to the writing of Topic Guides on our wishlist as part of the online <mark>Topic Guide Sprint being held on **Tuesday May 14, 2024 9:00-11:00 (BST)**</mark>. 
...
2. Have a look at our current [**Topic Guide Wishlist**](https://docs.google.com/spreadsheets/d/1FYR9UyZ7lWJOfsucZspw5sm9rmnTtHXecaYpCbVvDdI/edit#gid=851320609). Please let us know of any and all topic guides you would be happy to work on during the day of the sprint. You can do this by either completing the checklist with your Registration or directly editing the google spreadsheet. Feel free to select more than one if there are a number of topics you feel happy to write about. On the day each attendee will focus on writing just one Topic Guide. The information you provide before the sprint will help us organise this ahead of time so that as many Topic Guides as possible have at least one dedicated author. 
3. Please have a quick read through the **Contribution Guidance and Style Guide** section below. 
4. If you've been sent a copy of the [**Topic Guide Template (Google Doc)**](https://drive.google.com/drive/folders/1okdNMn1Jg1M8Enzavuqe_elsWH0uV1p1?usp=sharing) that corresponds to your topic of choice ahead of time, add your name to the header, and feel free to add notes or even make a start on drafting your guide before the sprint day if you're keen! 
