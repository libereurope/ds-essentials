...
5. At the end of the day of the sprint, we'd like contributors to open an Issue in Github using the Issue Template to let us know what the status is of your Topic Guide (for example is it ready to be reviewed/published or does more need doing after the sprint). We can walk people through that on the day.
