...
Equally, if you feel well versed in the basics already and are keen to dive straight into the AI context, **feel free to hop on down to the [Relevance to the Library section](https://libereurope.github.io/ds-essentials/copyright.html#relevance-to-the-library-sector-case-studiesuse-cases)**.
...
This guide contains a ton of resources for learning about copyright but for something a little bit different, check out the [Copyright Card Game](https://copyrightliteracy.org/resources/copyright-the-card-game/) or online quizzes such as [European Copyright 10 Questions](https://www.era-comm.eu/stream/Free_e-presentations/Demo_Course_European_Copyright_10_Questions/story_html5.html). 
