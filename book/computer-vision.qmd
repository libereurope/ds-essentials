...
There are plenty of Computer Vision tutorials on Google Colab Notebooks, [one great example being this one](https://github.com/domingomery/visioncolab).<br/>
[TensorFlow Playground](https://playground.tensorflow.org/) allows you to experiment with neural network architectures in order to understand how those work.<br/>
...
There are numerous publications on Computer Vision, but a couple worth highlighting:<br/>
