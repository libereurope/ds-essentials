...
GitHub allows people to collaboratively work on and share projects (called ‘repositories’) so that others can copy them, either to adapt or to contribute back to the original project. That’s because any ‘public’ repository of files on GitHub is accessible via the web. Repositories may be filled with code, but they also may be filled with pages of text written in [markdown](https://www.markdownguide.org/getting-started/) and this markdown can be rendered by browsers as webpages. This very website you’re reading this on right now is [being hosted on GitHub](https://github.com/libereurope/ds-essentials)!
...
Some ways in which library professionals collaborate on, contribute to and make use of GitHub based projects:
