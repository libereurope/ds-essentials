...
GitHub is a collaborative software development platform. Like a kind of google docs but for coders. It began as a tool for coders to collaboratively work on software development projects, ie, allowing different coders to contribute to parts of an overall project and keeping track of changes to make sure the end result is one cohesive software. GitHub today however is used for many more different purposes by people in different fields, not just software developers and software projects, to:  
...
GitHub allows people to share projects (called ‘repositories’) so that others can copy them, either to adapt or to contribute back to the original project. In fact, this very website you’re on right now is being hosted on GitHub and that’s because any ‘public’ repository of files on GitHub is accessible via the web. Repositories may be filled with code, but they also may be filled with pages of text written in “[markdown](https://github.github.com/gfm/) (or [another link](https://www.markdownguide.org/))” and this markdown can be rendered by browsers as webpages.
...
- **GitHub** is a web-based software development platform. It has many of Git’s features and can host Git repositories but also provides a web interface and additional functionalities. You can view millions of repositories hosted there. Many are openly licensed, meaning you can freely copy (or _fork_) them, either to adapt for yourself or to contribute back to the original project. By default the files and folders in a repository you create are public, but a repository can also be turned into a more public-facing project website, blog or wiki using a feature called GitHub Pages.
...
Here are some examples of library activity on GitHub:
...
- Collaborating on and contributing to a project \[example-Contributing to our DS Essentials project!\]

(based on from [Week one reading for "Git and GitHub for Librarians" course](https://gist.github.com/chrisdaaz/c0f93b9d30ae3a1fc19e9d8394efad12#file-git-for-librarians-md) and Library Carpentry [Library Carpentry: Introduction to Git: Summary and Setup](https://librarycarpentry.org/lc-git/) with some additions of our own!)

### Three ways in which library professionals collaborate and contribute to GitHub based projects
...
**3. Find the file you would like to change and make your edits**  
    Navigate to the file you would like to edit in your copy of DSEssentials on GitHub that you want to contribute to and click the pencil icon to edit. (Note that one way you’ll know you’re working in your own copy is by seeing your personal username ahead of the repository name). Let’s say the Topic Guide on AI & ML in Libraries Literacies needs an update. Look for a markdown file in the directory which corresponds to the url on the website version and has the file extension .md and (or, because this website was built using Quarto, the file extension in this example is .qmd). For instance if ml-ai.html is the web version, you would look for ml-ai.qmd in the file directory on GitHub.
...
When you are finished with your changes and would like to share your new updated copy with the original project (in this example, incorporating your new text on Generative AI into the main DS Essentials Topic Guide on AI & ML in Libraries) this is when you will start a [_pull request_](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request-from-a-fork). Navigate to the Pull Requests section of your project and click on New pull request to start that process.

![](https://github.com/libereurope/ds-essentials/blob/main/book/images/GitHub6.png?raw=true)

This will take you to back to the main project where you can then formally “create a pull request”. Once this has been made your pull request notifies the maintainers of the original project that you have made changes to their project that they may like to consider _merging_ into theirs. Your pull request will show up under their project where you can discuss and review the changes you’re suggesting. Once the review has been completed and everyone is happy with the changes suggested the maintainer of the project will merge your pull request and you will have officially contributed!

![](https://github.com/libereurope/ds-essentials/blob/main/book/images/GitHub7.png?raw=true)

#### **3. Re-using existing code/content for a new project**   

Let’s say that instead of just contributing to an existing project you may want to make use of the whole thing. This is quite common for instance when looking to reuse software that someone has created and shared on GitHub. And it’s a similar process to the above although in this case it would be more typical to [_clone_](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository) the repository rather than _fork_ it as cloning allows you to save the whole repository directly to your local machine, rather than within the GitHub platform itself. Developers will find this much more practical as they go through the process of editing and updating the changes they need to make. For instance, we talked about the example of a variety of open source Omeka plugins being available from the Omeka GitHub repository in the introduction.

[https://GitHub.com/omeka/omeka-s?tab=readme-ov-file#installing-from-GitHub](https://github.com/omeka/omeka-s?tab=readme-ov-file#installing-from-github)
...
Our list below is not intended to be comprehensive but is a selection of what is out there and all have been used by library staff like ourselves!:

### Learn the basics
- [This tutorial teaches you GitHub essentials like repositories, branches, commits, and pull requests.](https://docs.github.com/en/get-started/start-your-journey/hello-world)
- [This tutorial uses the Spoon-Knife project, a test repository that's hosted on GitHub.com that lets you test the fork and pull request workflow.](https://docs.github.com/en/get-started/exploring-projects-on-github/contributing-to-a-project)
