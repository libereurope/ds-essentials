...
>Contributor by: Nora McGregor, [ORCID iD](https://orcid.org/0000-0001-6560-5586)
>
...
## Relevance to the Library Sector: Large Language Models (LLM) and ChatGPT Uses in Libraries Today
...
(openai.com)]{.underline}](https://openai.com/chatgpt) interface. For this you'll need to have a free google account. 
...
gleaned from the suggested readings in this guide):
